...
function createBaseTaskRequest(): TaskRequest {
  return { text2text: undefined, text2image: undefined, text2audio: undefined, capitalize: undefined };
}
...
export const TaskRequest = {
  encode(message: TaskRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.capitalize !== undefined) {
      CapitalizeRequest.encode(message.capitalize, writer.uint32(34).fork()).ldelim();
    }
    return writer;
  },
...
export const TaskResponse = {
  encode(message: TaskResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.capitalize !== undefined) {
      CapitalizeResponse.encode(message.capitalize, writer.uint32(34).fork()).ldelim();
    }
    return writer;
  },
