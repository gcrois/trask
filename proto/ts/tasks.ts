...
export const TaskRequest = {
  encode(message: TaskRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.text2audio !== undefined) {
      Text2audioRequest.encode(message.text2audio, writer.uint32(10).fork()).ldelim();
    }
    ...
    if (message.turboedit !== undefined) {
      TurboeditRequest.encode(message.turboedit, writer.uint32(26).fork()).ldelim();
    }
    ...
    if (message.text2prompt !== undefined) {
      Text2promptRequest.encode(message.text2prompt, writer.uint32(50).fork()).ldelim();
    }
    ...
    if (message.text2image !== undefined) {
      Text2imageRequest.encode(message.text2image, writer.uint32(66).fork()).ldelim();
    }
    if (message.image2caption !== undefined) {
      Image2captionRequest.encode(message.image2caption, writer.uint32(74).fork()).ldelim();
    }
    if (message.text2imagedraft !== undefined) {
      Text2imagedraftRequest.encode(message.text2imagedraft, writer.uint32(82).fork()).ldelim();
    }
    return writer;
  },
...
export const TaskResponse = {
  encode(message: TaskResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.text2audio !== undefined) {
      Text2audioResponse.encode(message.text2audio, writer.uint32(10).fork()).ldelim();
    }
    if (message.capitalize !== undefined) {
      CapitalizeResponse.encode(message.capitalize, writer.uint32(18).fork()).ldelim();
    }
    if (message.turboedit !== undefined) {
      TurboeditResponse.encode(message.turboedit, writer.uint32(26).fork()).ldelim();
    }
    if (message.text2text !== undefined) {
    ...
    if (message.text2prompt !== undefined) {
      Text2promptResponse.encode(message.text2prompt, writer.uint32(50).fork()).ldelim();
    }
    if (message.text2imagefile !== undefined) {
      Text2imagefileResponse.encode(message.text2imagefile, writer.uint32(58).fork()).ldelim();
    }
    if (message.text2image !== undefined) {
      Text2imageResponse.encode(message.text2image, writer.uint32(66).fork()).ldelim();
    }
    if (message.image2caption !== undefined) {
      Image2captionResponse.encode(message.image2caption, writer.uint32(74).fork()).ldelim();
    }
    if (message.text2imagedraft !== undefined) {
      Text2imagedraftResponse.encode(message.text2imagedraft, writer.uint32(82).fork()).ldelim();
    }
    return writer;
  },
