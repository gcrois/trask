...
export const Text2imagedraftRequest = {
  encode(message: Text2imagedraftRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.prompt !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): Text2imagedraftRequest {
  ...
  create<I extends Exact<DeepPartial<Text2imagedraftRequest>, I>>(base?: I): Text2imagedraftRequest {
    return Text2imagedraftRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<Text2imagedraftRequest>, I>>(object: I): Text2imagedraftRequest {
    const message = createBaseText2imagedraftRequest();
...
export const Text2imagedraftResponse = {
  encode(message: Text2imagedraftResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): Text2imagedraftResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<Text2imagedraftResponse>, I>>(base?: I): Text2imagedraftResponse {
    return Text2imagedraftResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<Text2imagedraftResponse>, I>>(object: I): Text2imagedraftResponse {
    const message = createBaseText2imagedraftResponse();
...
export const Text2promptRequest = {
  encode(message: Text2promptRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.prompt !== "") {
      writer.uint32(10).string(message.prompt);
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): Text2promptRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<Text2promptRequest>, I>>(base?: I): Text2promptRequest {
    return Text2promptRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<Text2promptRequest>, I>>(object: I): Text2promptRequest {
    const message = createBaseText2promptRequest();
    message.prompt = object.prompt ?? "";
...
export const Text2promptResponse = {
  encode(message: Text2promptResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.result !== "") {
      writer.uint32(10).string(message.result);
    }
    return writer;
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): Text2promptResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<Text2promptResponse>, I>>(base?: I): Text2promptResponse {
    return Text2promptResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<Text2promptResponse>, I>>(object: I): Text2promptResponse {
    const message = createBaseText2promptResponse();
    message.result = object.result ?? "";
    return message;
  },
...
function createBaseTurboeditRequest(): TurboeditRequest {
  return { inputImage: undefined, srcPrompt: "", tgtPrompt: "", seed: 0, w1: 0 };
}

export const TurboeditRequest = {
  encode(message: TurboeditRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  fromJSON(object: any): TurboeditRequest {
    return {
      inputImage: isSet(object.inputImage) ? File.fromJSON(object.inputImage) : undefined,
      srcPrompt: isSet(object.srcPrompt) ? globalThis.String(object.srcPrompt) : "",
      tgtPrompt: isSet(object.tgtPrompt) ? globalThis.String(object.tgtPrompt) : "",
      seed: isSet(object.seed) ? globalThis.Number(object.seed) : 0,
  ...
  create<I extends Exact<DeepPartial<TurboeditRequest>, I>>(base?: I): TurboeditRequest {
    return TurboeditRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<TurboeditRequest>, I>>(object: I): TurboeditRequest {
    const message = createBaseTurboeditRequest();
    message.inputImage = (object.inputImage !== undefined && object.inputImage !== null)
...
export const TurboeditResponse = {
  encode(message: TurboeditResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.result !== undefined) {
      File.encode(message.result, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  ...
  create<I extends Exact<DeepPartial<TurboeditResponse>, I>>(base?: I): TurboeditResponse {
    return TurboeditResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<TurboeditResponse>, I>>(object: I): TurboeditResponse {
    const message = createBaseTurboeditResponse();
    message.result = (object.result !== undefined && object.result !== null)
      ? File.fromPartial(object.result)
      : undefined;
...
export const TaskRequest = {
  encode(message: TaskRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.text2imagedraft !== undefined) {
      Text2imagedraftRequest.encode(message.text2imagedraft, writer.uint32(10).fork()).ldelim();
    }
    ...
    if (message.capitalize !== undefined) {
      CapitalizeRequest.encode(message.capitalize, writer.uint32(26).fork()).ldelim();
    }
    if (message.text2text !== undefined) {
      Text2textRequest.encode(message.text2text, writer.uint32(34).fork()).ldelim();
    }
    if (message.image2caption !== undefined) {
      Image2captionRequest.encode(message.image2caption, writer.uint32(42).fork()).ldelim();
    }
    if (message.text2audio !== undefined) {
      Text2audioRequest.encode(message.text2audio, writer.uint32(50).fork()).ldelim();
    }
    if (message.file2text !== undefined) {
      File2textRequest.encode(message.file2text, writer.uint32(58).fork()).ldelim();
    }
    if (message.text2prompt !== undefined) {
      Text2promptRequest.encode(message.text2prompt, writer.uint32(66).fork()).ldelim();
    }
    if (message.turboedit !== undefined) {
      TurboeditRequest.encode(message.turboedit, writer.uint32(74).fork()).ldelim();
    }
    if (message.text2imagefile !== undefined) {
      Text2imagefileRequest.encode(message.text2imagefile, writer.uint32(82).fork()).ldelim();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          message.text2imagedraft = Text2imagedraftRequest.decode(reader, reader.uint32());
          continue;
        case 2:
          if (tag !== 18) {
            break;
        ...
        case 8:
          ...
          message.text2prompt = Text2promptRequest.decode(reader, reader.uint32());
          continue;
        case 9:
          if (tag !== 74) {
            break;
          ...
          message.turboedit = TurboeditRequest.decode(reader, reader.uint32());
          continue;
        case 10:
          if (tag !== 82) {
            break;
  ...
  fromJSON(object: any): TaskRequest {
    return {
      ...
      text2prompt: isSet(object.text2prompt) ? Text2promptRequest.fromJSON(object.text2prompt) : undefined,
      turboedit: isSet(object.turboedit) ? TurboeditRequest.fromJSON(object.turboedit) : undefined,
  ...
  toJSON(message: TaskRequest): unknown {
    const obj: any = {};
    if (message.text2imagedraft !== undefined) {
      obj.text2imagedraft = Text2imagedraftRequest.toJSON(message.text2imagedraft);
    }
    if (message.text2image !== undefined) {
  ...
  fromPartial<I extends Exact<DeepPartial<TaskRequest>, I>>(object: I): TaskRequest {
    const message = createBaseTaskRequest();
    message.text2imagedraft = (object.text2imagedraft !== undefined && object.text2imagedraft !== null)
    ...
    message.file2text = (object.file2text !== undefined && object.file2text !== null)
      ...
      : undefined;
    message.text2prompt = (object.text2prompt !== undefined && object.text2prompt !== null)
      ? Text2promptRequest.fromPartial(object.text2prompt)
      : undefined;
    message.turboedit = (object.turboedit !== undefined && object.turboedit !== null)
...
export const TaskResponse = {
  encode(message: TaskResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.text2imagedraft !== undefined) {
      Text2imagedraftResponse.encode(message.text2imagedraft, writer.uint32(10).fork()).ldelim();
    }
    if (message.text2image !== undefined) {
      Text2imageResponse.encode(message.text2image, writer.uint32(18).fork()).ldelim();
    }
    if (message.capitalize !== undefined) {
      CapitalizeResponse.encode(message.capitalize, writer.uint32(26).fork()).ldelim();
    }
    if (message.text2text !== undefined) {
      Text2textResponse.encode(message.text2text, writer.uint32(34).fork()).ldelim();
    }
    if (message.image2caption !== undefined) {
      Image2captionResponse.encode(message.image2caption, writer.uint32(42).fork()).ldelim();
    }
    if (message.text2audio !== undefined) {
      Text2audioResponse.encode(message.text2audio, writer.uint32(50).fork()).ldelim();
    }
    if (message.file2text !== undefined) {
      File2textResponse.encode(message.file2text, writer.uint32(58).fork()).ldelim();
    }
    if (message.text2prompt !== undefined) {
      Text2promptResponse.encode(message.text2prompt, writer.uint32(66).fork()).ldelim();
    }
    if (message.turboedit !== undefined) {
      TurboeditResponse.encode(message.turboedit, writer.uint32(74).fork()).ldelim();
    }
    if (message.text2imagefile !== undefined) {
      Text2imagefileResponse.encode(message.text2imagefile, writer.uint32(82).fork()).ldelim();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          message.text2imagedraft = Text2imagedraftResponse.decode(reader, reader.uint32());
          continue;
        case 2:
          if (tag !== 18) {
            break;
        ...
        case 8:
          ...
          message.text2prompt = Text2promptResponse.decode(reader, reader.uint32());
          continue;
        case 9:
          if (tag !== 74) {
            break;
          ...
          message.turboedit = TurboeditResponse.decode(reader, reader.uint32());
          continue;
        case 10:
          if (tag !== 82) {
            break;
  ...
  fromJSON(object: any): TaskResponse {
    return {
      ...
      text2prompt: isSet(object.text2prompt) ? Text2promptResponse.fromJSON(object.text2prompt) : undefined,
      turboedit: isSet(object.turboedit) ? TurboeditResponse.fromJSON(object.turboedit) : undefined,
  ...
  toJSON(message: TaskResponse): unknown {
    const obj: any = {};
    if (message.text2imagedraft !== undefined) {
      obj.text2imagedraft = Text2imagedraftResponse.toJSON(message.text2imagedraft);
    }
    if (message.text2image !== undefined) {
