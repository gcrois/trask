...
export const ClientMessage = {
		...
		while (reader.pos < end) {
			...
			switch (tag >>> 3) {
				case 1:
					...
					message.availableTasks = AvailableTasks.decode(
						reader,
						reader.uint32(),
					);
					continue;
				case 2:
					...
					message.execute = ExecuteTask.decode(
						reader,
						reader.uint32(),
					);
					continue;
				case 3:
					...
					message.fileResponse = FileResponse.decode(
						reader,
						reader.uint32(),
					);
					continue;
				case 4:
					...
					message.fileReceive = FileReceive.decode(
						reader,
						reader.uint32(),
					);
					continue;
				...
				case 7:
					...
					message.handshake = ClientHandshake.decode(
						reader,
						reader.uint32(),
					);
					continue;
	...
	fromJSON(object: any): ClientMessage {
		return {
			availableTasks: isSet(object.availableTasks)
				? AvailableTasks.fromJSON(object.availableTasks)
				: undefined,
			execute: isSet(object.execute)
				? ExecuteTask.fromJSON(object.execute)
				: undefined,
			fileResponse: isSet(object.fileResponse)
				? FileResponse.fromJSON(object.fileResponse)
				: undefined,
			fileReceive: isSet(object.fileReceive)
				? FileReceive.fromJSON(object.fileReceive)
				: undefined,
			pause: isSet(object.pause)
				? Pause.fromJSON(object.pause)
				: undefined,
			resume: isSet(object.resume)
				? Resume.fromJSON(object.resume)
				: undefined,
			handshake: isSet(object.handshake)
				? ClientHandshake.fromJSON(object.handshake)
				: undefined,
		};
	},
	...
	create<I extends Exact<DeepPartial<ClientMessage>, I>>(
		base?: I,
	): ClientMessage {
	...
	fromPartial<I extends Exact<DeepPartial<ClientMessage>, I>>(
		...
		const message = createBaseClientMessage();
		message.availableTasks =
			object.availableTasks !== undefined &&
			object.availableTasks !== null
				? AvailableTasks.fromPartial(object.availableTasks)
				: undefined;
		message.execute =
			object.execute !== undefined && object.execute !== null
		...
		message.fileResponse =
			object.fileResponse !== undefined && object.fileResponse !== null
				...
				: undefined;
		message.fileReceive =
			object.fileReceive !== undefined && object.fileReceive !== null
				? FileReceive.fromPartial(object.fileReceive)
				: undefined;
		message.pause =
			object.pause !== undefined && object.pause !== null
				? Pause.fromPartial(object.pause)
				: undefined;
		message.resume =
...
export const ServerMessage = {
		...
		while (reader.pos < end) {
			...
			switch (tag >>> 3) {
				case 1:
					...
					message.acceptTask = AcceptTask.decode(
						reader,
						reader.uint32(),
					);
					continue;
				case 2:
					...
					message.noTaskAvailable = NoTaskAvailable.decode(
						reader,
						reader.uint32(),
					);
					continue;
				case 3:
					...
					message.taskResult = TaskResult.decode(
						reader,
						reader.uint32(),
					);
					continue;
				case 4:
					...
					message.incrementalUpdate = IncrementalUpdate.decode(
						reader,
						reader.uint32(),
					);
					continue;
				case 5:
					...
					message.error = ErrorResponse.decode(
						reader,
						reader.uint32(),
					);
					continue;
				case 6:
					...
					message.fileRequest = FileRequest.decode(
						reader,
						reader.uint32(),
					);
					continue;
				...
				case 8:
					...
					message.requestAvailableTasks =
						RequestAvailableTasks.decode(reader, reader.uint32());
					continue;
				case 9:
					if (tag !== 74) {
						break;
					...
					message.handshake = ServerHandshake.decode(
						reader,
						reader.uint32(),
					);
					continue;
	...
	fromJSON(object: any): ServerMessage {
		return {
			acceptTask: isSet(object.acceptTask)
				? AcceptTask.fromJSON(object.acceptTask)
				: undefined,
			noTaskAvailable: isSet(object.noTaskAvailable)
				? NoTaskAvailable.fromJSON(object.noTaskAvailable)
				: undefined,
	...
	toJSON(message: ServerMessage): unknown {
		...
		if (message.noTaskAvailable !== undefined) {
			obj.noTaskAvailable = NoTaskAvailable.toJSON(
				message.noTaskAvailable,
			);
		}
		if (message.taskResult !== undefined) {
		...
		if (message.incrementalUpdate !== undefined) {
			obj.incrementalUpdate = IncrementalUpdate.toJSON(
				message.incrementalUpdate,
			);
		}
		if (message.error !== undefined) {
		...
		if (message.requestAvailableTasks !== undefined) {
			obj.requestAvailableTasks = RequestAvailableTasks.toJSON(
				message.requestAvailableTasks,
			);
		}
		if (message.handshake !== undefined) {
	...
	fromPartial<I extends Exact<DeepPartial<ServerMessage>, I>>(
		...
		const message = createBaseServerMessage();
		message.acceptTask =
			object.acceptTask !== undefined && object.acceptTask !== null
				? AcceptTask.fromPartial(object.acceptTask)
				: undefined;
		message.noTaskAvailable =
			object.noTaskAvailable !== undefined &&
			object.noTaskAvailable !== null
				? NoTaskAvailable.fromPartial(object.noTaskAvailable)
				: undefined;
		message.taskResult =
			object.taskResult !== undefined && object.taskResult !== null
				? TaskResult.fromPartial(object.taskResult)
				: undefined;
		message.incrementalUpdate =
			object.incrementalUpdate !== undefined &&
			object.incrementalUpdate !== null
		...
		message.error =
			object.error !== undefined && object.error !== null
				...
				: undefined;
		message.fileRequest =
			object.fileRequest !== undefined && object.fileRequest !== null
				? FileRequest.fromPartial(object.fileRequest)
				: undefined;
		message.fileSend =
			object.fileSend !== undefined && object.fileSend !== null
				? FileSend.fromPartial(object.fileSend)
				: undefined;
		message.requestAvailableTasks =
			object.requestAvailableTasks !== undefined &&
			object.requestAvailableTasks !== null
				? RequestAvailableTasks.fromPartial(
						object.requestAvailableTasks,
					)
				: undefined;
		message.handshake =
			object.handshake !== undefined && object.handshake !== null
...
export const RequestAvailableTasks = {
	...
	create<I extends Exact<DeepPartial<RequestAvailableTasks>, I>>(
		base?: I,
	): RequestAvailableTasks {
		return RequestAvailableTasks.fromPartial(base ?? ({} as any));
	},
	fromPartial<I extends Exact<DeepPartial<RequestAvailableTasks>, I>>(
		object: I,
	): RequestAvailableTasks {
		const message = createBaseRequestAvailableTasks();
...
export const AvailableTasks = {
	...
	create<I extends Exact<DeepPartial<AvailableTasks>, I>>(
		base?: I,
	): AvailableTasks {
		return AvailableTasks.fromPartial(base ?? ({} as any));
	},
	fromPartial<I extends Exact<DeepPartial<AvailableTasks>, I>>(
		object: I,
	): AvailableTasks {
		const message = createBaseAvailableTasks();
		...
		while (reader.pos < end) {
			...
			switch (tag >>> 3) {
				...
				case 3:
					...
					message.request = TaskRequest.decode(
						reader,
						reader.uint32(),
					);
					continue;
	...
	fromJSON(object: any): Task {
		return {
			...
			request: isSet(object.request)
				? TaskRequest.fromJSON(object.request)
				: undefined,
		};
	},
...
export const ExecuteTask = {
	...
	create<I extends Exact<DeepPartial<ExecuteTask>, I>>(
		base?: I,
	): ExecuteTask {
		return ExecuteTask.fromPartial(base ?? ({} as any));
	},
	fromPartial<I extends Exact<DeepPartial<ExecuteTask>, I>>(
		object: I,
	): ExecuteTask {
		const message = createBaseExecuteTask();
...
export const ClientHandshake = {
	...
	create<I extends Exact<DeepPartial<ClientHandshake>, I>>(
		base?: I,
	): ClientHandshake {
		return ClientHandshake.fromPartial(base ?? ({} as any));
	},
	fromPartial<I extends Exact<DeepPartial<ClientHandshake>, I>>(
		object: I,
	): ClientHandshake {
		const message = createBaseClientHandshake();
...
export const ServerHandshake = {
	...
	create<I extends Exact<DeepPartial<ServerHandshake>, I>>(
		base?: I,
	): ServerHandshake {
		return ServerHandshake.fromPartial(base ?? ({} as any));
	},
	fromPartial<I extends Exact<DeepPartial<ServerHandshake>, I>>(
		object: I,
	): ServerHandshake {
		const message = createBaseServerHandshake();
		message.version = object.version ?? "";
...
export const AcceptTask = {
	...
	fromPartial<I extends Exact<DeepPartial<AcceptTask>, I>>(
		object: I,
	): AcceptTask {
		const message = createBaseAcceptTask();
		message.taskId = object.taskId ?? "";
...
export const NoTaskAvailable = {
	...
	create<I extends Exact<DeepPartial<NoTaskAvailable>, I>>(
		base?: I,
	): NoTaskAvailable {
		return NoTaskAvailable.fromPartial(base ?? ({} as any));
	},
	fromPartial<I extends Exact<DeepPartial<NoTaskAvailable>, I>>(
		_: I,
	): NoTaskAvailable {
		const message = createBaseNoTaskAvailable();
		return message;
...
export const TaskResult = {
		...
		while (reader.pos < end) {
			...
			switch (tag >>> 3) {
				...
				case 2:
					...
					message.result = TaskResponse.decode(
						reader,
						reader.uint32(),
					);
					continue;
	...
	fromJSON(object: any): TaskResult {
		return {
			...
			result: isSet(object.result)
				? TaskResponse.fromJSON(object.result)
				: undefined,
		};
	},
	...
	fromPartial<I extends Exact<DeepPartial<TaskResult>, I>>(
		object: I,
	): TaskResult {
		const message = createBaseTaskResult();
		message.taskId = object.taskId ?? "";
...
export const IncrementalUpdate = {
		...
		while (reader.pos < end) {
			...
			switch (tag >>> 3) {
				...
				case 3:
					...
					message.update = TaskResponse.decode(
						reader,
						reader.uint32(),
					);
					continue;
	...
	fromJSON(object: any): IncrementalUpdate {
		return {
			...
			update: isSet(object.update)
				? TaskResponse.fromJSON(object.update)
				: undefined,
		};
	},
	...
	create<I extends Exact<DeepPartial<IncrementalUpdate>, I>>(
		base?: I,
	): IncrementalUpdate {
		return IncrementalUpdate.fromPartial(base ?? ({} as any));
	},
	fromPartial<I extends Exact<DeepPartial<IncrementalUpdate>, I>>(
		object: I,
	): IncrementalUpdate {
		const message = createBaseIncrementalUpdate();
		message.taskId = object.taskId ?? "";
...
export const FileRequest = {
	...
	create<I extends Exact<DeepPartial<FileRequest>, I>>(
		base?: I,
	): FileRequest {
...
export const FileReceive = {
	...
	create<I extends Exact<DeepPartial<FileReceive>, I>>(
		base?: I,
	): FileReceive {
		return FileReceive.fromPartial(base ?? ({} as any));
	},
	fromPartial<I extends Exact<DeepPartial<FileReceive>, I>>(
		object: I,
	): FileReceive {
		const message = createBaseFileReceive();
		message.fileId = object.fileId ?? "";
...
export const FileResponse = {
	...
	create<I extends Exact<DeepPartial<FileResponse>, I>>(
		base?: I,
	): FileResponse {
...
export const FileSend = {
	...
	fromPartial<I extends Exact<DeepPartial<FileSend>, I>>(
		object: I,
	): FileSend {
		const message = createBaseFileSend();
		message.fileId = object.fileId ?? "";
