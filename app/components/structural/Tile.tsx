...
type TileChild = React.ReactElement<{children: React.ReactElement<{label: string}>}>;
...
export const Tile: React.FC<TileProps> = (props) => {
	...
	const views = React.useMemo(() => {
		return React.Children.toArray(props.children).map((child) => {
			...
			return [child.props.label, React.cloneElement(child, {
                ...child.props,
            })];
		}) ?? []}, [props.children]);
